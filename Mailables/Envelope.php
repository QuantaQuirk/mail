...
namespace QuantaQuirk\Mail\Mailables;
...
class Envelope
{
     ...
     *
     * @var \QuantaQuirk\Mail\Mailables\Address|string|null
     */
    public $from;
     ...
     *
     * @param  \QuantaQuirk\Mail\Mailables\Address|string|null  $from
     * @param  array  $to
     * @param  array  $cc
     * @param  array  $bcc
     * @param  array  $replyTo
     ...
     *
     * @param  \QuantaQuirk\Mail\Mailables\Address|string  $address
     ...
     *
     * @param  \QuantaQuirk\Mail\Mailables\Address|array|string  $address
     * @param  string|null  $name
     * @return $this
     */
