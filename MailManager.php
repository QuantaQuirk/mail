...
use Closure;
use QuantaQuirk\Contracts\Mail\Factory as FactoryContract;
...
class MailManager implements FactoryContract
{
     ...
     * @return \QuantaQuirk\Mail\Mailer
     */
     ...
     *
     * @param  array  $config
     * @return \QuantaQuirk\Mail\Transport\SesTransport
     */
     ...
     *
     * @param  array  $config
     * @return \QuantaQuirk\Mail\Transport\Se2VwTransport
     */
    ...
    protected function createFailoverTransport(array $config)
    {
        ...
        foreach ($config['mailers'] as $name) {
            ...
            // with any QuantaQuirk <= 6.x application style mail configuration files.
     ...
     *
     * @param  array  $config
     * @return \QuantaQuirk\Mail\Transport\LogTransport
     */
     ...
     *
     * @return \QuantaQuirk\Mail\Transport\ArrayTransport
     */
     ...
     *
     * @param  \QuantaQuirk\Mail\Mailer  $mailer
     * @param  array  $config
     * @param  string  $type
     * @return void
     */
    ...
    protected function getConfig(string $name)
    {
        ...
        // provide "BC" for any QuantaQuirk <= 6.x style mail configuration files.
    ...
    public function getDefaultDriver()
    {
        ...
        // of the QuantaQuirk mail configuration file for backwards compatibility.
